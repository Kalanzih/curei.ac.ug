<?php include 'header.php'; ?>
    ...
    <section class="pop-cour">
        <div class="container com-sp pad-bot-70">
            <div class="row">
                <div class="con-title">
                    <h2>Bachelors <span>Courses</span></h2>
         ...
         <div class="container">
           ...
           <?php $bachelors = dbSQL("SELECT * FROM bachelors ORDER BY bachelors.bach_id DESC ");
                        ...
                        <div class="home-top-cour"  style="background: #d9dce5;">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details">
                                    <h3 style="font-size: 18px; color: #29419a"><?=$bachelors->course_name; ?></h3>
                                </a>
