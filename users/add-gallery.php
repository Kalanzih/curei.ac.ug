                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                <label>Event: </label>
                                                    <input type="text" class="form-control" name="event" placeholder="Enter Full Name. " required>
                                                </div>
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                <label>Description: </label>
                                                    <input type="text" class="form-control" name="breif" placeholder="Enter Description. " required>
                                                </div>
                                            </div>
                                                                                                                                      
                                            <div class="row">
                                            <div class="form-group">
                                            <button class="btn btn-primary" type="submit"  name="submit_upload_add_gallery_btn" style="width:50%;">UPLOAD</button>
                                    </div>
                                        </div>
                                    </form>
                                </div>
