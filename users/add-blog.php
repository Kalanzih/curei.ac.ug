                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <?php 
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <label>Header: </label>
                                                    <input type="text" class="form-control" name="header" placeholder="Enter Blog Header. " required>
                                                </div>
                                            </div>
                                             <div class="form-group">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                <label>Body: </label>
                                                    <textarea name="body" rows="4" cols="8" ></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                            <div class="form-group">
                                        <button class="btn btn-primary" type="submit"  name="submit_upload_add_blogs_btn"  style="width:50%;">UPLOAD</button>
                                    </div>
                                        </div>
                                    </form>
                                </div>
