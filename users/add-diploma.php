                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <?php 
                                            ...
                                            <div class="row">
                                            <div class="form-group">
                                        <button class="btn btn-primary" type="submit"  name="submit_upload_add_diplomas_btn" style="width:50%;">UPLOAD</button>
                                    </div>
                                        </div>
                                    </form>
                                </div>
