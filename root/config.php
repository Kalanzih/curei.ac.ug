...
switch(DB_URL){
	case 'localhost':
		...
		defined ("DB_NAME") or define("DB_NAME", "curei");
		defined ("SITE_URL") or define("SITE_URL", 'http://localhost/curei.ac.ug');
		defined ("HOME_URL") or define("HOME_URL", 'http://localhost/curei.ac.ug');
	break;

	case 'https://www.zupafinances.com': 
		defined ("DB_SERVER") or define("DB_SERVER", 'localhost');
		defined ("DB_USER") or define("DB_USER", "gilug_info");
		defined ("DB_PASS") or define("DB_PASS", "Y?BG-x3S%,iM");
		defined ("DB_NAME") or define("DB_NAME", "zupa_finance_db");
		defined ("SITE_URL") or define("SITE_URL", 'https://Zupa-Finances.com');
		defined ("HOME_URL") or define("HOME_URL", 'https://gilug.Zupa-Finances');
	break;
